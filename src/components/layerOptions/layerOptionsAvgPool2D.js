...
export default class LayerOptionsAvgPool2D extends React.Component{ // komponent nastavení hlasovacej vrstvy s výberom priemernej hodnoty
  ...
  handlePoolSizeChange2 = (event) =>{
    this.setState({
      poolSize: [this.state.poolSize[0], parseInt(event.target.value)]
    });
  }
